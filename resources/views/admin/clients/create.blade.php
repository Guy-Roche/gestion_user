...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Ajouter un client </strong></div>
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="{{ route('admin.clients.store')}}" method="POST">
                        ...
                        <div class="form-group form-check">
                            ...
                            <input type="radio" class="form-check-input" name="sexe" value="F" id="f"  >
                        ...
                        <div class="form-group form-check">
                            ...
                            <input type="radio" class="form-check-input" name="sexe" value="M" id="m"  >
